...
from . import chatbot_sessions, dashboard, appointments, payments, counselling_sessions, prescription, sentiments
...
normal_user_router.include_router(sentiments.router)
